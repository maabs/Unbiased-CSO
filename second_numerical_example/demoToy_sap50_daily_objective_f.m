...
rng('default')
%%
load sp500_daily_adj_close_and_rets_top400.mat;     
%%
time_d(1)
%tickers_d(100)
time_d(end)
...
aOpts = struct();
saOpts.Ksa       = 20;      % number of SA iterations
saOpts.gamma     = 3;       % risk aversion
saOpts.blockSize = 512;     % for Sigmar_times_beta_exact / matvec batching
saOpts.a0        = 10*6000/saOpts.gamma;     % base stepsize
saOpts.aPow      = 0.6;     % stepsize exponent
saOpts.xiClip    = 20;      % stabilize softmax
...
%%
repro.onlineOpts.saOptsBase
repro.mcmcoptions.train
...
saOptsBase.a0        = 180000/saOptsBase.gamma;     % base stepsize
saOptsBase.aPow      = 0.6;
...
% saOptsBase.gamma     = 20; sharpe was 2.37 compared to 1.96
% saOptsBase.a0        = 20000/saOptsBase.gamma;
...
fname = sprintf('repro_online_s&p_252d_every1_%s_gamma12_top_239_latest_dates.mat', datestr(now,'yyyymmdd_HHMMSS'));
