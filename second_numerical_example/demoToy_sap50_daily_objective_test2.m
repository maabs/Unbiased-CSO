...
saOptsBase.a0        = 40000/saOptsBase.gamma;     % base stepsize
saOptsBase.aPow      = 0.6;
...
fname = sprintf('repro_online_s&p_252d_every1_%s_gamma12_top_300_reptest_latest_dates.mat', datestr(now,'yyyymmdd_HHMMSS'));
...
out_dir = fullfile(pwd, 'repro_runs');
file = fullfile(out_dir, 'repro_online_stoxx_europe_252d_every1_20260312_133953_gamma12_top_300.mat');
